...
CAPTION_TO_PNG = {
    ...
    "Figure 2.2": "ch2-kt-evolution-timeline",
    "Table 2.1": "ch2-detailed-comparison-table",
    "Table 2.2": "ch2-technique-complementarity-table",
    "Figure 2.3": "ch2-spaced-repetition-evolution",
    "Figure 3.1": "ch3-system-architecture-diagram",
    "Table 3.1": "ch3-functional-requirements-table",
    "Table 3.2": "ch3-non-functional-requirements-table",
    "Table 3.3": "ch3-requirements-traceability-table",
    "Figure 3.2": "ch3-knowledge-graph-diagram",
    "Table 3.4": "ch3-hyperparameter-summary-table",
    ...
    "Table 4.3": "ch4-fsrs-rating-mapping-table",
