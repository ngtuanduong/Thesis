...
- **File:** `ch1-platform-comparison-table.html`
...
- **File:** `ch1-research-gap-diagram.html`
...
- **File:** `ch1-closed-loop-workflow.html`
...
- **File:** `ch1-five-layer-architecture-overview.html`
...
- **File:** `ch1-thesis-structure-roadmap.html`
...
- **File:** `ch2-literature-landscape-map.html`
...
- **File:** `ch2-detailed-comparison-table.html`
...
- **File:** `ch2-technique-complementarity-table.html`
...
- **File:** `ch2-kt-evolution-timeline.html`
...
- **File:** `ch2-spaced-repetition-evolution.html`
...
- **File:** `ch3-functional-requirements-table.html`
...
- **File:** `ch3-knowledge-graph-diagram.html`
...
- **File:** `ch3-recommendation-sequence-diagram.html`
...
- **File:** `ch3-submission-processing-flow.html`
...
- **File:** `ch3-hyperparameter-summary-table.html`
...
- **File:** `ch3-database-schema-erd.html`
...
- **File:** `ch3-layer-interaction-matrix.html`
...
- **File:** `ch3-cold-start-flowchart.html`
...
- **File:** `ch3-caching-strategy-table.html`
- **Type:** Formatted HTML table (APA style)
...
|---|-----------|------|---------|
| 1 | `ch1-platform-comparison-table.html` | Table | Ch.1 |
| 2 | `ch1-research-gap-diagram.html` | Figure (Venn) | Ch.1 |
| 3 | `ch1-closed-loop-workflow.html` | Figure (Flowchart) | Ch.1 |
| 4 | `ch1-five-layer-architecture-overview.html` | Figure (Layers) | Ch.1 |
| 5 | `ch1-thesis-structure-roadmap.html` | Figure (Roadmap) | Ch.1 |
| 6 | `ch2-literature-landscape-map.html` | Figure (Convergence) | Ch.2 |
| 7 | `ch2-detailed-comparison-table.html` | Table | Ch.2 |
| 8 | `ch2-technique-complementarity-table.html` | Table | Ch.2 |
| 9 | `ch2-kt-evolution-timeline.html` | Figure (Timeline) | Ch.2 |
| 10 | `ch2-spaced-repetition-evolution.html` | Figure (Timeline) | Ch.2 |
| 11 | `ch3-functional-requirements-table.html` | Table (x2) | Ch.3 |
| 12 | `ch3-system-architecture-diagram.html` | Figure (Architecture) | Ch.3 |
| 13 | `ch3-knowledge-graph-diagram.html` | Figure (DAG) | Ch.3 |
| 14 | `ch3-recommendation-sequence-diagram.html` | Figure (Sequence) | Ch.3 |
| 15 | `ch3-submission-processing-flow.html` | Figure (Flowchart) | Ch.3 |
| 16 | `ch3-hyperparameter-summary-table.html` | Table | Ch.3 |
| 17 | `ch3-database-schema-erd.html` | Figure (ERD) | Ch.3 |
| 18 | `ch3-layer-interaction-matrix.html` | Figure (Matrix) | Ch.3 |
| 19 | `ch3-cold-start-flowchart.html` | Figure (Flowchart) | Ch.3 |
| 20 | `ch3-caching-strategy-table.html` | Table | Ch.3 |
