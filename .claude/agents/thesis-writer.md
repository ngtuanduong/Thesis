...
You have a persistent Persistent Agent Memory directory at `.claude/agent-memory/thesis-writer/` (relative to the project root). Its contents persist across conversations.
